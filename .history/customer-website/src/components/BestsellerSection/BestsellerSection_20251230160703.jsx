          ...
          {products.map((item, i) => (
            ...
            >
              ...
              <button
                ...
                className={`absolute top-4 right-4 w-9 h-9 rounded-full flex items-center justify-center z-10 transition
                  ${wishlist[i] ? 'bg-[var(--primary)] text-white' : 'bg-white text-[var(--primary)]'}
                `}
              >
              ...
              <div className="flex items-center justify-between mt-4">
                ...
                <button
                  onClick={() => setQty(p => ({ ...p, [i]: (p[i] || 0) + 1 }))}
                  className="px-5 py-2 rounded-full text-xs font-semibold bg-[var(--primary)] text-white hover:bg-[var(--secondary)]"
                >
                  Add
                </button>
              </div>
