    ...
    return (
        <section className="py-10 -mt-8">
            <div className="max-w-6xl mx-auto">
                ...
                {/* Desktop Carousel */}
                <div className="hidden md:flex relative rounded-[60px] px-1 py-18 -mt-10 bg-cover bg-center bg-no-repeat flex items-center justify-center" style={{ backgroundImage: "url('Group 57.png')" }}>
