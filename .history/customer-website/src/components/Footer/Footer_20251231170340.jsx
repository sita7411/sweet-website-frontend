export default function Footer() {
  const latestProducts = [
    { img: "/products/chikki1.jpg", name: "Peanut Chikki", icon: "🥜" },
    { img: "/products/chikki2.jpg", name: "Sesame Chikki", icon: "🌾" },
    { img: "/products/chikki3.jpg", name: "Dry Fruit Chikki", icon: "🍇" },
    { img: "/products/chikki4.jpg", name: "Special Jaggery Bites", icon: "🍯" },
  ];
        ...
        <div className="md:col-span-2">
          ...
          <div className="flex gap-4 overflow-x-auto scrollbar-hide py-2">
            {latestProducts.map((item, i) => (
              <div
                key={i}
                className="flex-shrink-0 w-28 bg-[var(--bg-soft)] rounded-lg shadow-sm p-2 hover:shadow-lg transition cursor-pointer"
              >
                <div className="text-center text-xl mb-2">{item.icon}</div>
                <img
                  src={item.img}
                  alt={item.name}
