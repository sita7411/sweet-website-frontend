...
export default function Footer() {
    ...
    return (
        <footer className="bg-[var(--bg-main)] text-[var(--text-main)]">
            {/* Top Section */}
            <div className="max-w-7xl mx-auto px-3 py-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
                {/* Brand & Contact Info */}
                <div className="flex flex-col">
                    ...
                    />
                    <h4 className="font-bold text-xl mb-4">Marvel Crunch Chikki Store</h4>
