...
export default function Footer() {
    ...
    return (
        <footer className="bg-[var(--bg-main)] text-[var(--text-main)]">
            {/* Top Section */}
            <div className="max-w-7xl mx-auto px-4 py-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-10">
                ...
                <div className="flex flex-col col-span-1">
                    ...
                    {/* Address */}
                    <div className="flex items-start gap- text-sm text-[var(--text-muted)] mb-2">
            ...
            <div className="py-4 text-center text-sm text-[var(--text-muted)] flex flex-col md:flex-row justify-between items-center max-w-7xl mx-auto px-6">
                ...
                <p className="mt-2 md:mt-0">Designed with ❤️ by Marvel Chikki Team</p>
            </div>
        </footer>
    );
}
