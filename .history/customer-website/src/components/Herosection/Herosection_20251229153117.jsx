  ...
  return (
    <section className="min-h-screen bg-[#FFF8EE] flex items-center justify-between px-6 lg:px-20 gap-12">
      ...
      <div className="relative flex items-center justify-center">
        ...
        {/* BACK RINGS */}
        <div className="absolute w-[460px] h-[460px] rounded-full bg-orange-100 border border-yellow-200 opacity-40"></div>
        <div className="absolute w-[380px] h-[380px] rounded-full border border-yellow-200"></div>
