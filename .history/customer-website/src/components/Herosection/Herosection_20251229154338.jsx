    ...
    <section className="min-h-screen bg-[#FFF9F1] flex items-center px-6 lg:px-24 gap-16">
      ...
      <div className="max-w-xl">
        ...
        <p className="mt-6 text-gray-600 text-lg leading-relaxed">
          {active.desc}. Crafted using premium nuts, seeds and pure jaggery —
          blending tradition with innovative flavours.
        </p>
        ...
        <div className="mt-10 flex items-center gap-4">
          ...
          <input
            ...
            className="px-6 py-3 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-yellow-400 text-sm"
          />
        </div>
      </div>
      ...
      <div className="relative flex items-center justify-center flex-1">
        ...
        {/* BACK RINGS */}
        <div className="absolute w-[460px] h-[460px] rounded-full bg-yellow-100 opacity-40"></div>
        <div className="absolute w-[380px] h-[380px] rounded-full border border-yellow-300"></div>
