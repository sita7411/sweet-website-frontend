...
export default function HeroBanner() {
  ...
  return (
    <section className="min-h-screen bg-[#FFF9F1] flex items-center px-20 overflow-hidden">
      ...
      {/* CENTER IMAGE */}
<div className="relative w-[420px] h-[420px] flex flex-col items-center justify-center">
  ...
  {/* INNER RING 2 */}
  <div className="absolute w-[280px] h-[280px] -mr-2 rounded-full border border-[#F5C36A] opacity-70" />
