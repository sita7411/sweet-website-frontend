...
export default function HeroBanner() {
  ...
  return (
    <section className="min-h-screen bg-[#FFF9F1] flex items-center px-20 overflow-hidden">
      ...
      {/* CENTER + RIGHT */}
      <div className="ml-auto flex items-center -mr-12">

      {/* CENTER IMAGE */}
<div className="relative w-[460px] h-[460px] flex flex-col items-center justify-center">

  {/* OUTER SOFT GLOW */}
  <div className="absolute inset-0 rounded-full bg-[#FFE9C9] opacity-60" />

  {/* INNER RING 1 */}
  <div className="absolute w-[340px] h-[340px] rounded-full border border-[#F5C36A]" />

  {/* INNER RING 2 */}
  <div className="absolute w-[280px] h-[280px] -ml-6 rounded-full border border-[#F5C36A] opacity-70" />
