...
const tabs = [
    {
        ...
        floatLeft: 'pista_icon.png', // <-- added for left floating
...
export default function HeroBanner() {
    ...
    return (
        <section className="min-h-screen bg-[#FFF9F1] flex items-center px-20 overflow-hidden relative">
            ...
            <div className="w-[480px] relative">
                ...
                {active.floatLeft && (
                    <motion.img
                        ...
                        className="absolute -top-8 -left-10 w-24 z-20"
                        animate={{ y: [0, 8, 0] }}
