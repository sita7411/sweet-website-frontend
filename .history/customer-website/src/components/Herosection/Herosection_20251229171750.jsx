...
const tabs = [
  ...
  },
  {
    ...
    floatRight: '/images/float-choco.png',
  ...
  },
  {
    ...
    floatRight: '/images/float-nuts.png',
    ...
    <section className="min-h-[90vh] sm:min-h-[80vh] bg-[#FFF9F1] flex flex-col items-center justify-center px-6 sm:px-10 relative overflow-hidden">
      ...
      <div className="relative mt-12 sm:mt-16 w-[350px] sm:w-[500px] h-[350px] sm:h-[500px] flex items-center justify-center">
        ...
        {active.floatTop && (
          <motion.img
            src={active.floatTop}
            className="absolute -top-6 sm:-top-8 md:-top-10 w-16 sm:w-24 md:w-28 z-30"
            style={{ right: '10%' }}
        ...
        {active.floatLeft && (
          <motion.img
            ...
            className="absolute top-1/2 -translate-y-1/2 w-16 sm:w-24 md:w-28 z-20"
            style={{ left: '5%' }}
        ...
        {active.floatBottom && (
          <motion.img
            ...
            className="absolute bottom-4 sm:bottom-6 left-16 sm:left-24 md:left-32 w-14 sm:w-20 md:w-24 z-20"
