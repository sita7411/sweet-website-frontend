...
{isLoggedIn ? (
  ...
  <div className="relative hidden sm:block group">
    ...
    <div className="absolute right-0 mt-4 w-52 bg-white rounded-xl shadow-xl border invisible group-hover:visible">
      ...
      <button className="flex items-center gap-2 px-5 py-2 text-[var(--primary)] hover:bg-[var(--bg-soft)] w-full">
        <LogOut size={16} />
        Logout
      </button>
    </div>
  ...
  <div className="hidden sm:flex items-center gap-3">
    ...
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="px-6 py-2 rounded-full bg-[var(--primary)] text-white text-sm font-semibold shadow-md"
    >
      Sign Up
    </motion.a>
