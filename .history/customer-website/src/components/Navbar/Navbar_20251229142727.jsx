...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 h-[87px] flex items-center justify-between">
        ...
        <nav className="hidden lg:flex gap-8 text-sm font-semibold uppercase">
          ...
          <div className="relative group">
            ...
            <motion.div
              ...
              className="absolute top-full mt-4 w-64 rounded-2xl bg-white
              shadow-2xl border border-gray-100 invisible group-hover:visible
              overflow-hidden"
            >
              {/* Arrow */}
              <span className="absolute -top-2 right-6 w-4 h-4 bg-white rotate-45 border-l border-t border-gray-100" />
        ...
        <div className="flex items-center ml-8 gap-3">
          ...
          {isLoggedIn ? (
            <div className="relative hidden sm:block group">
              ...
              <div className="absolute right-0 mt-4 w-52 bg-white rounded-xl
              shadow-xl border invisible group-hover:visible">
                <AccountItem label="My Orders" />
                <AccountItem label="Profile" />
                <div className="border-t my-2" />
                <button className="flex items-center gap-2 px-5 py-2
                text-[var(--primary)] hover:bg-[var(--bg-soft)] w-full">
                  <LogOut size={16} />
                  Logout
                </button>
              </div>
