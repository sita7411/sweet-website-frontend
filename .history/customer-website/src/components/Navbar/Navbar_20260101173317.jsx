  ...
  const [cartItems, setCartItems] = useState([
    {
      ...
      price: 190.48,
      quantity: 1,
      img: "/images/biscuti.png", // replace with your image
    },
    {
      id: 2,
      ...
      <AnimatePresence>
        {cartOpen && (
          ...
          >
            ...
            {/* Hyperlocal Delivery Card */}
            <div className="bg-yellow-50 p-4 mx-4 rounded-lg text-center mb-4">
              <h4 className="font-semibold text-sm mb-1">Hyperlocal Delivery</h4>
              <p className="text-xs text-gray-600 mb-2">
                Craving sweets nearby? Enjoy <b>fast and fresh</b> delivery from
                our outlets within 3–6 km in Gurugram, Delhi, Faridabad, Sohna & Palwal.
              </p>
              <button className="bg-yellow-400 text-white text-sm px-4 py-2 rounded-full">
                Order Locally
              </button>
            </div>
            ...
            <div className="border-t border-gray-200 p-4">
              ...
              <button className="w-full bg-[var(--primary)] text-white py-2 rounded-lg mb-2">
                Check Out
              </button>
