...
import React, { useState, useEffect, useRef } from "react"; // <-- React add karo
        ...
        {cartOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 h-full w-96 bg-[var(--bg-card)] shadow-xl z-50 flex flex-col"
            >
              {/* Header */}
...
const IconBtn = ({ children, className = "", onClick }) => (
  <div
    ...
    `}
  >
    {/* Icons are lucide-react SVGs, use stroke classes */}
    {children && React.cloneElement(children, {
      className: `${children.props.className || ''} stroke-[var(--primary)] group-hover:stroke-white transition-all duration-200`
    })}
  </div>
);
