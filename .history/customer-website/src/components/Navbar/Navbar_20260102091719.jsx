      ...
      <AnimatePresence>
        ...
        bg-[var(--bg-card)] shadow-2xl z-[9999] flex flex-col"
            >
              ...
              {/* Footer */}
              <div className="border-t px-5 py-2 space-y-4">
                {/* Subtotal */}
                ...
                {/* Checkout */}
                <button className="w-full bg-[var(--primary)] text-white py-2 rounded-xl
          font-semibold hover:opacity-90 transition">
                  Proceed to Checkout
                </button>

                <button className="w-full border border-[var(--primary)] text-[var(--primary)]
