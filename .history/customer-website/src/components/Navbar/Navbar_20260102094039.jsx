  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 h-[90px] flex items-center justify-between">
        ...
        {/* MOBILE SEARCH BAR – LOGO KE NICHE */}
{/* MOBILE SEARCH BAR – LOGO KE NICHE */}
<AnimatePresence>
  {mobileSearchOpen && (
    <motion.div
      ...
      className="lg:hidden border-t bg-[var(--bg-main)]"
    >
      <div className="px-4 py-3">
        <div className="relative">
          ...
          />
          <button
            className="absolute right-3 top-1/2 -translate-y-1/2 text-[var(--primary)] hover:text-white p-1 rounded-full transition"
...
>
  ...
  py-2 rounded-xl text-sm hover:bg-[var(--primary)] hover:text-white transition"
>
  View Full Cart
</button>
