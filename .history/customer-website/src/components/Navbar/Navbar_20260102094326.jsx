      ...
      <div className="lg:hidden px-4 pb-2">
        <div className="relative">
          ...
          <input
            ...
            bg-[var(--bg-soft)] focus:ring-2 focus:ring-[var(--primary)]
            outline-none"
          />
        </div>
      </div>
  ...
  {mobileMenuOpen && (
    <>
      ...
      >
        ...
        {/* Optional Bottom Login / Auth Button */}
        <div className="px-6 py-4 border-t">
          {isLoggedIn ? (
            <button className="w-full bg-[var(--primary)] text-white py-3 rounded-xl font-semibold hover:opacity-90 transition">
              Logout
            </button>
          ) : (
            <a
        ...
        {cartOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 h-full w-full sm:w-[380px] md:w-[420px]
              bg-[var(--bg-card)] shadow-2xl z-[9999] flex flex-col"
            >
           <AnimatePresence>
  {cartOpen && (
    <>
