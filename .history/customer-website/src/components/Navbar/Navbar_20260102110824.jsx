      ...
      <AnimatePresence>
        {cartOpen && (
          <>
            ...
            />
            <motion.div initial={{ x: "100%" }} animate={{ x: 0 }} exit={{ x: "100%" }} transition={{ type: "tween", duration: 0.35 }} className="fixed right-0 top-0 h-full w-full sm:w-[320px] md:w-[420px] bg-[var(--bg-card)] shadow-2xl z-[9999] flex flex-col">
              {/* HEADER */}
