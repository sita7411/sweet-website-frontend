...
const OfferSection = () => {
  ...
  return (
    <section
      className="relative flex items-center justify-center py-24 md:py-32 bg-cover bg-center bg-no-repeat"
      style={{
        backgroundImage: `url('https://images.unsplash.com/photo-1617196038282-f2d1c3b61c23?auto=format&fit=crop&w=1350&q=80')`,
        minHeight: '400px',
      }}
    >
