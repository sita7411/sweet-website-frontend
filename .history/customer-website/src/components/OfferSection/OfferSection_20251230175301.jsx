  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 md:px-12 text-center">
        <h2 className="text-3xl md:text-5xl font-bold text-[var(--accent)]">CRUNCHY & SWEET</h2>
<h3 className="text-2xl md:text-4xl font-extrabold text-[var(--text-main)] mt-2">CHIKKI</h3>
...
<button className="mt-6 px-8 py-3 bg-[var(--accent)] text-white font-bold rounded hover:bg-yellow-700 transition">
  ORDER NOW
</button>
