  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="w-120 mx-auto my-4 -mb-2 h-px bg-gradient-to-r from-transparent via-[#d8cfc4] to-transparent"></div>
        ...
        <div className="w-72 mx-auto my-4 h-px bg-gradient-to-r from-transparent via-[#d8cfc4] to-transparent"></div>
        ...
        {/* Price Badge */}
        <div className="absolute top-10 right-10 rotate-[-10deg] bg-[#f6c23e] text-[#3a2416] px-5 py-3 rounded-full font-extrabold text-lg shadow-lg">
          ONLY ₹199!
        </div>
      </div>
    </section>
