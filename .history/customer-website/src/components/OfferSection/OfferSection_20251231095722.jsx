    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
        ...
        <div className="sm:hidden -mt-18">
          ...
          {/* Mobile Countdown */}
          <div className="grid grid-cols-4 mb-10 gap-3 text-[#3a2416]">
            {[
          ...
          <button className="mt-6 px-6 py-2.5 bg-[#5a2d14] text-white text-sm font-bold rounded-md">
            ORDER NOW
          </button>
        </div>
