  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
        ...
        {/* ================= MOBILE VIEW ================= */}
        <div className="sm:hidden h-full min-h-[280px] flex flex-col justify-between py-8">

          {/* 🔝 TOP CONTENT */}
          <div>
            <h2 className="text-3xl -mt-25 font-extrabold text-[#d99a2b] tracking-wide">
              CRUNCHY & SWEET
            </h2>

            <div className="w-16 h-[2px] bg-[#d99a2b] mx-auto my-3"></div>

            <h3 className="text-[19px] font-extrabold text-[#3a2416]">
              CHIKKI
            </h3>
          ...
          {/* 🔽 BOTTOM CONTENT */}
          <div>
            <div className="my-4 h-px -mt-20 bg-gradient-to-r from-transparent via-[#d8cfc4] to-transparent"></div>

            <div className="grid grid-cols-4 -mt-20 gap-3 text-[#3a2416]">
              {[
                ...
                <div key={item.label} className="text-center">
                  ...
                  <div className="text-[10px] tracking-widest">{item.label}</div>
                </div>
              ))}
            </div>

            <button className="mt-6 px-6 py-2.5 bg-[#5a2d14] text-white text-sm font-bold rounded-md w-full">
              ORDER NOW
            </button>
          </div>
        </div>
