  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
        ...
        {/* ================= MOBILE VIEW ================= */}
        <div className="sm:hidden h-[290px] flex flex-col justify-between px-4 py-6 relative">

          {/* Top heading */}
          <div className="text-center">
            <h2 className="text-3xl -mt-24 font-extrabold text-[#d99a2b] tracking-wide">
              CRUNCHY & SWEET
            </h2>
          ...
          <div className="text-center">
            <div className="grid mt-60 grid-cols-4 gap-3 text-[#3a2416] mb-4">
              {[
