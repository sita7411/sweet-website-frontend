...
const OfferSection = () => {
  ...
  return (
 <section
  className="relative bg-no-repeat bg-center bg-cover py-30
             bg-[url('/chikki_offer_banner_mobile.png')] sm:bg-[url('/chikki_banner_offer.png')]"
>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
        ...
        <div className="sm:hidden h-[380px] flex flex-col justify-between px-4 py-6 relative">
          ...
          <div className="text-center">
            <h2 className="text-4xl -mt-18 font-extrabold text-[#d99a2b] tracking-wide">
              CRUNCHY & SWEET
            </h2>
          ...
          <div className="text-center">
            <div className="grid mt-63 grid-cols-4 gap-3 text-[#3a2416] mb-4">
              {[
