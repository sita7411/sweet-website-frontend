    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
        ...
        <div className="sm:hidden h-[400px] py-46 flex flex-col justify-between px-4 py-6 relative">
          ...
          <div className="text-center">
            <div className="grid mt-30 grid-cols-4 gap-3 text-[#3a2416] mb-4">
              {[
        ...
        <div className="hidden sm:block">
          ...
          <div className="max-w-md mx-auto my-5 -mb-3 h-px bg-gradient-to-r from-transparent via-[#d8cfc4] to-transparent"></div>
