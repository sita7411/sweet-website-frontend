  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
        ...
        {/* ================= MOBILE VIEW ================= */}
<div className="sm:hidden h-[400px] flex flex-col justify-between px-4 py-6 relative">

  {/* Top heading */}
  <div className="text-center">
    <h2 className="text-4xl font-extrabold text-[#d99a2b] tracking-wide">
      CRUNCHY & SWEET
    </h2>
  ...
  <div className="text-center mt-6">
    <div className="grid grid-cols-4 gap-2 text-[#3a2416] mb-4">
      {[ 
  ...
  <img
    src="/offer_tag.png"
    alt="Price ₹199"
    className="absolute top-2 right-3 w-[120px] rotate-[6deg] drop-shadow-lg"
  />
</div>
