  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
       ...
       {/* ================= MOBILE VIEW ================= */}
<div className="sm:hidden h-[400px] py-46 flex flex-col justify-between px-4 py-6 relative">

  {/* Top heading */}
  <div className="text-center">
    <h2 className="text-4xl -mt-40 font-extrabold text-[#d99a2b] tracking-wide">
      CRUNCHY & SWEET
    </h2>
  ...
  <div className="text-center">
    <div className="flex justify-center items-center mt-6 mb-4 gap-2 text-[#3a2416]">
      {[
  ...
  {/* Mobile Price Tag */}
  <img
    src="/offer_tag_mobile.png"
    alt="Price ₹199"
    className="absolute top-2 right-2 w-[100px] sm:hidden rotate-[6deg] drop-shadow-lg"
  />
</div>
