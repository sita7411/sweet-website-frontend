  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
       ...
       {/* ================= MOBILE VIEW ================= */}
<div className="sm:hidden h-[400px] py-56 flex flex-col justify-between px-4 py-6 relative">
  ...
  <div className="text-center">
    ...
    <h3 className="text-[20px] font-extrabold text-[#3a2416]">CHIKKI</h3>
  ...
  <img
    src="/offer_tag.png"
    alt="Price ₹199"
    className="absolute top-12 -right-4 w-[150px] sm:hidden rotate-[6deg] drop-shadow-lg"
  />
</div>
