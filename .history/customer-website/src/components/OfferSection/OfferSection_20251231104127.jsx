  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
        {/* ================= MOBILE VIEW ================= */}
        <motion.div
          className="sm:hidden h-[400px] py-56 flex flex-col justify-between px-4 py-6 relative"
          initial="hidden"
          animate="visible"
          variants={fadeUp}
        >
          <motion.div className="text-center" variants={fadeUp}>
            <h2 className="text-4xl -mt-56 font-extrabold text-[#d99a2b] tracking-wide">
              CRUNCHY & SWEET
            </h2>
        ...
        {/* ================= DESKTOP VIEW ================= */}
        <motion.div className="hidden sm:block" initial="hidden" animate="visible" variants={fadeUp}>
          <motion.h2 className="text-4xl md:text-5xl font-extrabold mt-9 text-[#d99a2b] tracking-wide" variants={fadeUp}>
            CRUNCHY & SWEET
          </motion.h2>
          ...
          <motion.button
            className="mt-7 px-10 py-3 bg-[#5a2d14] text-white text-base font-bold rounded-md hover:bg-[#3a1b0d] transition"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
            ORDER NOW
