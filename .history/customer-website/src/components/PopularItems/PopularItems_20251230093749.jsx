  ...
  return (
    <section className="py-28 bg-[var(--bg-main)]">
      <div className="max-w-6xl mx-auto">
        ...
        {/* ===== Slider Container ===== */}
        <div className="relative bg-[var(--bg-soft)] rounded-[60px] px-20 py-18 shadow-[0_25px_60px_rgba(0,0,0,0.12)]">
          ...
          <div className="grid grid-cols-4 gap-10">
            {items.map((item, index) => (
              ...
              >
                ...
                {/* Actions */}
                <div className="flex items-center justify-between mt-6 mr-2">
                  <motion.button
