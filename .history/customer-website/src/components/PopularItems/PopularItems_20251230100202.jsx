...
const items = [
  ...
  // Add more items if needed for better scrolling feel
];
    ...
    <section className="py-32 bg-[var(--bg-main)] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="relative group">
          ...
          <button className="absolute left-4 top-1/2 -translate-y-1/2 hidden md:flex items-center justify-center w-14 h-14 rounded-full bg-white/90 backdrop-blur shadow-xl hover:scale-110 transition z-20">
            <ChevronLeftIcon className="w-7 h-7 text-[var(--text-main)]" />
          </button>
          <button className="absolute right-4 top-1/2 -translate-y-1/2 hidden md:flex items-center justify-center w-14 h-14 rounded-full bg-white/90 backdrop-blur shadow-xl hover:scale-110 transition z-20">
