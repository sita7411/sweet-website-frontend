...
export default function PopularItems() {
  return (
    <section className="py-28 ">
      ...
      <div
  className="absolute inset-0 bg-[#FFE8A3] shadow-[0_30px_70px_rgba(0,0,0,0.15)]"
  style={{
    borderRadius: '140px',

    WebkitMaskImage: `
      linear-gradient(black, black),
      radial-gradient(circle 120px at 120px 50%, transparent 99%, black 100%),
      radial-gradient(circle 120px at calc(100% - 120px) 50%, transparent 99%, black 100%)
    `,
    ...
    WebkitMaskComposite:
      'source-over, destination-out, destination-out',
  }}
/>
