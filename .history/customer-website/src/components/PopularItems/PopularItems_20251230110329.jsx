             ...
             bg-cover bg-center bg-no-repeat"
                ...
                "
                  ...
                  "
                    ...
                    {/* Right Arrow */}
                    <button className="absolute right-1 top-1/2 -translate-y-1/2 w-19 h-12 rounded-full bg-white shadow flex items-center justify-center hover:scale-110 transition">
