    ...
    return (
        <section className="py-28 ">
            <div className="max-w-6xl mx-auto">
                ...
                {/* ===== Slider Container ===== */}
                <div
                    className="relative rounded-[60px] px-20 py-18
             bg-cover bg-center bg-no-repeat"
                ...
                >
                    ...
                    {/* Left Arrow */}
                    <button className="absolute left-6 top-1/2 -translate-y-1/2 w-19 h-19 rounded-full bg-white shadow flex items-center justify-center hover:scale-110 transition">
                        <ChevronLeftIcon className="w-5 h-8 text-[var(--text-main)]" />
                    </button>
