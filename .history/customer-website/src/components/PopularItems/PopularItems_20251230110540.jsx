            ...
            <div className="max-w-6xl mx-auto">
             ...
             bg-cover bg-center bg-no-repeat"
                ...
                >
                    ...
                    {/* Left Arrow */}
                    <button className="absolute -left-5 top-1/2 -translate-y-1/2 w-19 h-19 rounded-full bg-white shadow flex items-center justify-center hover:scale-110 transition">
