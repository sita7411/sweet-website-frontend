  ...
  return (
    <section className="py-28">
      <div className="max-w-6xl mx-auto">
        ...
        {/* ===== Slider Container (visually static) ===== */}
        <div
          className="relative rounded-[60px] px-20 py-18 bg-cover bg-center bg-no-repeat"
          style={{ backgroundImage: "url('Group 57.png')" }}
        >

          {/* Left Arrow (no functional change for now) */}
          <button className="absolute -left-7 top-1/2 -translate-y-1/2 w-19 h-19 rounded-full bg-white shadow flex items-center justify-center hover:scale-110 transition">
            <ChevronLeftIcon className="w-8 h-8 text-[var(--text-main)]" />
          </button>

          {/* Cards (grid remains exactly as it is) */}
          ...
          {/* Right Arrow (no functional change for now) */}
          <button className="absolute -right-6 top-1/2 -translate-y-1/2 w-19 h-19 rounded-full bg-white shadow flex items-center justify-center hover:scale-110 transition">
