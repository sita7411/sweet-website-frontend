    ...
    <section className="py-28">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <button
            onClick={nextSlide}
            className="absolute -right-10 top-1/2 -translate-y-1/2 w-15 h-15 rounded-full bg-white shadow flex items-center justify-center hover:scale-110 transition"
          >
