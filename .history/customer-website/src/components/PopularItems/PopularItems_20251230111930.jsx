...
<div className="flex items-center justify-between mt-3">
  ...
  >
    <HeartIcon className="w-4 h-4 text-[var(--primary)]" />
          ...
          <button
            onClick={nextSlide}
            className="absolute -right-10 top-1/2 -translate-y-1/2 w-19 h-15 rounded-full bg-white shadow flex items-center justify-center hover:scale-110 transition"
          >
