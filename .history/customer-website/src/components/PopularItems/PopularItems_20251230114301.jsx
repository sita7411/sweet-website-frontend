    ...
    <section className="py-22">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <button
            onClick={prevSlide}
            className="absolute -left-10 top-1/2 -translate-y-1/2 w-19 h-19 rounded-full bg-white shadow flex items-center justify-center hover:scale-110 transition"
          >
          ...
          <button
            onClick={nextSlide}
            className="absolute -right-10 top-1/2 -translate-y-1/2 w-19 h-19 rounded-full bg-white shadow flex items-center justify-center hover:scale-110 transition"
          >
