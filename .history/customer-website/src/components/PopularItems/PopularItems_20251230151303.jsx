...
const items = [
  {
    ...
    subtitle: 'Chocolate & Peanut Blend',
    price: '₹250',
    rating: '5.0',
    img: 'pista.png',
  },
...
export default function PopularItems() {
  ...
  // Fix: always get exactly 4 items in a circular way
  ...
  return (
    <section className="py-10">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Cards Container */}
        <div
          className="relative rounded-[60px] px-13 py-18 -mt-8 bg-cover bg-center bg-no-repeat flex items-center justify-center"
        ...
        >
          ...
          {/* 4 Cards */}
          <div className="
  grid gap-10 mt-9 justify-center
  grid-cols-1
  sm:grid-cols-2
  lg:grid-cols-4
">
              ...
              >
                ...
                <div className="flex items-center justify-between mt-3">
                  ...
                  <motion.button
                    ...
                    className={`w-8 h-8 rounded-full flex items-center justify-center shadow transition ${wishlistItems[i]
                ...
                <div className="flex items-center justify-between mt-4 -ml-2 gap-3">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className={`flex items-center gap-2 text-xs px-5 py-1.5 rounded-full font-semibold shadow transition ${addedItems[i]
                        ? 'bg-[var(--accent)] text-white'
