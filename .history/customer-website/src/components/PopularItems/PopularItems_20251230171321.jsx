        ...
        <section className="py-10 -mt-8">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="hidden md:flex relative rounded-[60px] px-13 py-18 -mt-8 bg-cover bg-center bg-no-repeat flex items-center justify-center" style={{ backgroundImage: "url('Group 57.png')" }}>
                    <button onClick={prevSlide} className="absolute -left-4 top-1/2 -translate-y-1/2 w-19 h-19 rounded-full bg-white shadow flex items-center justify-center hover:scale-110 transition">
