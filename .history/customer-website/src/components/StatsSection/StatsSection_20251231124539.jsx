...
export default function StatsSection() {
  ...
  return (
    <section
      className="relative py-17 overflow-hidden bg-center bg-cover"
      style={{
        backgroundImage: "url('stats_banner.png')",
      }}
    >
      {/* Overlay (for text readability) */}
      <div className="absolute inset-0 bg-[var(--bg-main)] opacity-20"></div>
