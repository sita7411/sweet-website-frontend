      ...
      <div className="relative z-10 ">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-1 text-center px-6">
          {stats.map((stat, index) => (
            ...
            <div className="mb-4">
  {/* Outer ring */}
  <div className="w-20 h-20 rounded-full bg-[var(--bg-soft)] flex items-center justify-center shadow-sm">
    
    {/* Inner circle */}
    <div className="w-14 h-14 rounded-full bg-[var(--primary)] flex items-center justify-center shadow-md">
