                        ...
                        <div key={index} className="flex flex-col items-center">
                            ...
                            <div className="mb-4">
                                ...
                                <div
                                    ...
                                    style={{
                                        backgroundColor: '#F3D7A5',   // yellow fill
                                        border: '2px solid #E2B873',  // yellow border
                                    }}
                                >
                                    {/* Inner circle */}
                                    <div
                                        ...
                                        style={{
                                            backgroundColor: '#8B4513',  // brown fill
                                            border: '2px solid #6F2E0E', // dark brown border
                                        }}
                                    >
                                        <stat.icon className="w-7 h-7 text-[#FFDFA8]" />
                                    </div>
                                </div>
                            </div>
