...
export default function StatsSection() {
    ...
    return (
        <section
            className="relative py-12 overflow-hidden bg-center bg-cover"
            style={{
        ...
        >
            ...
            <div className="relative z-10">
                ...
                {/* Stats */}
                <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-8 text-center px-4">
