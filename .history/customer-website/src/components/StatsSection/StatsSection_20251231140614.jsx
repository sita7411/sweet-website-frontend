...
export default function StatsSection() {
    const stats = [
        { img: 'user.png', value: '5,000+', label: 'Happy Customers' },
        { img: 'cube.png', value: '50+', label: 'Chikki Varieties' },
        { img: 'sparkles.png', value: '10+', label: 'Special Flavors' },
        { img: 'cart.png', value: '1,00,000+', label: 'Chikki Sold' },
    ];
