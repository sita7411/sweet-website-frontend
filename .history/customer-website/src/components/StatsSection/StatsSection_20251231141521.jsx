...
export default function StatsSection() {
    const stats = [
        { img: 'user.png', value: '5,000+', label: 'Happy Customers', size: 'w-14 h-14' },
        { img: 'cube.png', value: '50+', label: 'Chikki Varieties', size: 'w-12 h-12' },
        { img: 'sparkles.png', value: '10+', label: 'Special Flavors', size: 'w-16 h-16' },
        { img: 'cart.png', value: '1,00,000+', label: 'Chikki Sold', size: 'w-14 h-14' },
    ];
                        ...
                        <div key={index} className="flex flex-col items-center relative px-2">
                            ...
                            <div className="mb-2">
                                ...
                                >
                                    {/* Inner circle */}
                                    <div
                                        className="w-20 h-20 rounded-full flex items-center justify-center shadow-md overflow-hidden"
                                        style={{
                                    ...
                                    >
                                        <img
                                            src={stat.img}
                                            alt={stat.label}
                                            className={`${stat.size} object-contain`}
                                        />
                                    </div>
                                </div>
                            </div>

                            <h3 className="text-2xl font-bold text-[var(--secondary)]">{stat.value}</h3>
                            <p className="mt-1 text-[var(--text-muted)] font-medium text-sm">{stat.label}</p>
                        </div>
                    ))}
                </div>
            </div>
