...
export default function SubscribeSection() {
  return (
    <section
      className="relative flex items-center justify-between p-8 rounded-[50px] bg-cover bg-center"
      style={{
        backgroundImage: "url('/images/bg-image.jpg')", // Replace with your background image path
      }}
    >
      {/* Left Text + Input */}
