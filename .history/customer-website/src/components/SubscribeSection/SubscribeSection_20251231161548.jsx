      ...
      <div className="relative w-full max-w-6xl min-h-[450px] flex items-center">
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 items-center gap-12 px-10 md:px-24 py-12 w-full">
          ...
          <div className="flex justify-center md:justify-end">
            <img
              src="/images/subscribe-product.png" // Apni image ka path yahan dein
              alt="Product"
              className="max-w-[280px] md:max-w-[420px] object-contain drop-shadow-2xl hover:scale-105 transition-transform duration-500"
            />
          </div>
