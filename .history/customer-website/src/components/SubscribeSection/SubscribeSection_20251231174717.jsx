                ...
                >
                    <defs>
                        ...
                        <linearGradient id="bgGradient" x1="0" y1="0" x2="1" y2="0">
                            <stop offset="90%" stopColor="#FFF3E3 " />
                        ...
                        <clipPath id="rightClip">
                            <path d="M784.5 15.5C834.5 15.5 866.5 47.5 866.5 97.5C866.5 137.5 842.5 157.5 881.5 197.5V292.5C842.5 332.5 866.5 352.5 866.5 392.5C866.5 442.5 834.5 474.5 784.5 474.5H440C440 474.5 430 0 430 0Z" />
                        </clipPath>

                        <clipPath id="leftClip">
                            <path d="M97.5 15.5C47.5 15.5 15.5 47.5 15.5 97.5C15.5 137.5 39.5 157.5 0.5 197.5V292.5C39.5 332.5 15.5 352.5 15.5 392.5C15.5 442.5 47.5 474.5 97.5 474.5H442C442 474.5 440 0 440 0Z" />
                        </clipPath>
                    </defs>
