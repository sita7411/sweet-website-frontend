      ...
      >
        ...
        >
          <div className="max-w-md mx-auto text-center">
            ...
            <div className="relative w-full aspect-square rounded-full overflow-hidden mb-8">
              <div className="absolute inset-0 bg-gradient-to-br from-[#FFF3E3] via-[#FFF7EC] to-[#EDD6B8]" />
              <img src="/side-img 3.png" className="absolute inset-0 w-full h-full object-cover opacity-80" />
              <img src="/side-img 2 (1).png" className="absolute inset-0 w-full h-full object-cover mix-blend-multiply" />
            </div>

            <h2 className="text-3xl font-serif text-[var(--text-main)]">
              Subscribe to <br /> Our Newsletter
            </h2>
            ...
            <div className="flex items-center bg-[#3a2416] rounded-full px-5 py-4 mt-6">
              <Mail size={18} className="text-white mr-3 opacity-70" />
              <input
                className="bg-transparent outline-none text-white w-full"
                placeholder="Enter your email"
            ...
            <button className="bg-[var(--primary)] text-white py-4 rounded-full w-full mt-3">
              Subscribe
            </button>
          </div>
        </motion.section>
