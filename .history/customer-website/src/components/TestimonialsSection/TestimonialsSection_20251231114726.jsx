      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-center items-stretch gap-10 relative">
          {testimonials.map((item, i) => (
            ...
            >
              {/* Unique Quote Design */}
              <div className="absolute -top-6 left-6 text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[var(--primary)] to-[var(--accent)]">
                ❝
              </div>
              <div className="absolute -bottom-6 right-6 text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[var(--accent)] to-[var(--primary)] rotate-180">
                ❞
              </div>
