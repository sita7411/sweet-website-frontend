export default function TestimonialsSection() {
  ...
  return (
    <section className="relative py-32 px-6 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1200px] h-[1200px] from-[var(--primary)] to-[var(--accent)] opacity-10 rounded-full filter blur-3xl pointer-events-none" />
