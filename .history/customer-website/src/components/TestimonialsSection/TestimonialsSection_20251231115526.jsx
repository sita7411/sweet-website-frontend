export default function TestimonialsSection() {
  ...
  return (
    <section className="relative py-32 px-6 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1200px] h-[1200px] opacity-10 rounded-full filter blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 right-1/2 translate-x-1/2 w-[800px] h-[800px] opacity-10 rounded-full filter blur-2xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-center items-stretch gap-10 relative">
          {testimonials.map((item, i) => (
            ...
            >
              {/* Decorative quote */}
              <div className="text-8xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[var(--primary)] to-[var(--accent)] mb-1">
                ❝
              </div>
              ...
              {/* Testimonial text */}
              <p className="text-[var(--text-muted)] text-base leading-relaxed mb-2">
                {item.text}
              </p>
