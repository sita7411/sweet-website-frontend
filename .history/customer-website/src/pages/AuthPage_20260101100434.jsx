...
export default function AuthPage() {
  return (
    ...
    <div className="h-screen w-full flex flex-col overflow-hidden bg-[#f9f3ef] font-sans relative">
      
      {/* Background Image/Texture Overlay (Optional) */}
      <div className="absolute inset-0 opacity-40 pointer-events-none" 
           style={{ backgroundImage: "url('your-chikki-texture.jpg')", backgroundSize: 'cover' }}></div>
