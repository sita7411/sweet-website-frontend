...
export default function AuthPage() {
  return (
    <div className="h-screen w-full overflow-hidden bg-[#f9f3ef] relative font-sans">
      ...
      {/* Texture Background */}
      <div
        className="absolute inset-0 bg-[url('/login-bg.jpg')] bg-cover opacity-20 pointer-events-none"
      />
      ...
      {/* FOOTER */}
      <footer className="relative z-10 px-10 py-6 flex justify-between text-sm text-[#7a2e1d]">
        ...
        <span className="text-gray-400 hidden md:block">
          ©2024 Shree Chikki. All rights reserved.
        </span>
      </footer>
    </div>
  );
