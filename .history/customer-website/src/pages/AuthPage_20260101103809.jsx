...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#f9f3ef] relative font-sans">
      ...
      {/* HEADER (compact) */}
      <header className="relative z-10 px-8 ml-50 py-4 flex items-center gap-3">
        <img src="/Logo_Marvel.png" className="w-15 h-20" />
        <div>
      ...
      {/* MAIN */}
      <main className="relative z-10 flex items-center justify-center px-6 lg:px-20 min-h-[calc(100vh-80px)]">
