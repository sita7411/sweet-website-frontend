...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#f9f3ef] relative font-sans overflow-hidden">
      ...
      {/* HEADER */}
      <header className="relative z-10 px-8 ml-44 py-4 flex items-center gap-3">
      ...
      <main className="relative z-10 flex items-center justify-center -mt-10 px-6 lg:px-20 min-h-[calc(100vh-80px)]">
        <div className="grid md:grid-cols-2 gap-16 w-full max-w-6xl items-center">
          ...
          {/* LEFT AUTH CARD */}
          <div className="bg-[#fffaf6] rounded-[28px] shadow-2xl max-w-[390px] w-full mx-auto">
            ...
            <div className="px-7 pb-6 space-y-2.5">
              ...
              <div className="flex items-center gap-3 my-3">
                ...
                <span className="text-[10px] text-[#8a6a52] uppercase tracking-wide">
                  OR
                </span>
                <div className="flex-1 h-px bg-[#eadbcf]" />
              </div>
