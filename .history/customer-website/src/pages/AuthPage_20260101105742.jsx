...
export default function AuthPage() {
  ...
  return (
    <div className="h-screen w-full bg-[#f9f3ef] relative font-sans overflow-hidden">
      ...
      {/* MAIN */}
      <main className="relative z-10 flex items-start justify-center px-4 lg:px-20 h-[calc(100vh-90px)] overflow-hidden">
    ...
    <div className="relative w-full">
      ...
      {open && (
        <ul
          ...
          bg-white shadow-lg text-sm text-[#7a2e1d] py-1"
        >
          {options.map((opt, i) => (
            <li
              key={i}
