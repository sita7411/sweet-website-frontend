  ...
  <ul className="space-y-4">
    {[
      ...
      <li key={i} className="flex items-start gap-3">
        {/* Professional Circle Checkbox */}
        <span className="flex-shrink-0 mt-1.5 w-5 h-5 flex items-center justify-center rounded-full bg-gradient-to-br from-[#f2a23a] to-[#d97b1c] shadow-md">
