    ...
    <div className="h-screen w-full bg-[#f9f3ef] relative font-sans overflow-hidden">
      ...
      <header className="relative z-10 px-4 md:px-8 py-3 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[10px] text-[#9b6a4a] italic tracking-wider">— Pure & Traditional Taste —</p>
        </div>
      </header>
      ...
      <main className="relative z-10 flex justify-center px-4 lg:px-20 h-[calc(100vh-80px)] overflow-hidden">
        <div className="flex flex-col md:grid md:grid-cols-2 gap-10 lg:gap-14 w-full max-w-6xl">
          ...
          <div className="hidden md:flex flex-col mt-6">
            <h3 className="text-3xl font-serif font-bold text-[#7a2e1d] mb-6">Why Marvel Crunch?</h3>
            <ul className="space-y-4">
              {[
                ...
                <li key={i} className="flex items-start gap-3">
                  ...
                  <span className="text-[#7a2e1d] text-sm leading-snug">{item}</span>
                </li>
              ))}
            </ul>
          </div>
  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="w-full pl-10 pr-4 py-2.5 rounded-full border border-[#f1e6dc] bg-[#fffdfb] text-xs focus:outline-none focus:ring-2 focus:ring-[#7a2e1d]/20"
      />
    </div>
  );
}
  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="w-full pl-10 pr-10 py-2.5 rounded-full border border-[#f1e6dc] bg-[#fffdfb] text-xs focus:outline-none focus:ring-2 focus:ring-[#7a2e1d]/20"
      />
      <button
        type="button"
