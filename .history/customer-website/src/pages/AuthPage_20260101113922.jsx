...
export default function AuthPage() {
    ...
    return (
        <div className="h-screen w-full bg-[#f9f3ef] relative font-sans overflow-hidden">
            ...
            {/* HEADER */}
            <header className="relative z-10 px-4 md:px-8 py-3 ml-120 flex items-center gap-3">
            ...
            {/* MAIN */}
            <main className="relative z-10 flex items-center justify-center px-4 -mt-12 lg:px-20 h-screen">
                <div className="bg-[#fffaf6] rounded-[26px] shadow-2xl w-full max-w-[380px] mx-auto
