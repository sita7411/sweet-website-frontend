...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#f9f3ef] relative font-sans overflow-hidden flex flex-col">
      ...
      {/* HEADER */}
   {/* HEADER */}
<header className="relative z-10 flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 py-4">
  <img src="/Logo_Marvel.png" className="w-16 h-16 sm:w-20 sm:h-20 mb-2" />
  <h1 className="text-lg sm:text-xl font-bold text-[#7a2e1d] text-center">
    Marvel Crunch Chikki
  </h1>
  <p className="text-[10px] sm:text-[12px] text-[#9b6a4a] italic tracking-wider text-center">
    — Pure & Traditional Taste —
      ...
      {/* MAIN */}
      <main className="relative z-10 flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-20 py-8">
