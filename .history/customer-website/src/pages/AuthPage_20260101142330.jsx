...
export default function AuthPage() {
    ...
    return (
        <div className="h-screen w-full bg-[#f9f3ef] relative font-sans overflow-hidden flex flex-col">
            ...
            {/* HEADER */}
            <header className="relative z-10 flex items-center justify-center mt-5 -mb-10 gap-2 py-3">
            ...
            <main className="relative z-10 flex-1 flex items-center justify-center px-2">
                <div
                    className={`bg-[#fffaf6] rounded-3xl shadow-xl w-full mx-auto px-6 py-4
  ${mode === "signup" ? "max-w-[630px]" : "max-w-[360px] px-10 py-6"}`}
                >
                    ...
                    <div className="space-y-6 ">
                        ...
                        {/* LOGIN */}
                        {mode === "login" && (
                            <div className="max-w-[290px] mx-auto space-y-3">
                                <Input icon={<Mail size={15} />} placeholder="Email Address" />
                                <PasswordInput />
                            </div>
                        )}
