...
// Initial Cart Items (Chikki Products)
const initialCart = [
  {
    id: 1,
...
const CartPage = () => {
  ...
  const handleAddAllToCheckout = () => {
    const inStockItems = cart.filter((item) => item.stock === 'In stock');
    if (inStockItems.length > 0) {
      toast.success('All in-stock items ready for checkout!');
    } else {
      toast.warn('No items in stock to checkout!');
    }
  };
  ...
  const shipping = subtotal > 500 ? 0 : 50; // Free shipping for ₹500+
      ...
      <div className="container mx-auto mt-10 mb-24 px-4 md:px-10">
        {cart.length === 0 ? (
          ...
          <div className="flex flex-col lg:flex-row gap-8">
                  ...
                  >
                    ...
                    <div className="mt-4 flex flex-col gap-3">
                      ...
                      <div className="flex gap-3">
                        <button
                          className={`flex-1 py-2 rounded font-semibold text-white whitespace-nowrap transition ${
                            item.stock === 'In stock'
            ...
            {/* Right: Order Summary */}
            <div className="w-full lg:w-[320px] bg-[var(--bg-card)] p-6 rounded-lg shadow flex flex-col gap-4">
              <h2 className="text-xl font-bold text-[var(--text-main)] mb-2">Order Summary</h2>
              ...
              <button className="w-full bg-[var(--primary)] text-white py-2 rounded hover:bg-[var(--secondary)] transition font-semibold">
                Proceed to Checkout
              </button>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-2">
                <button
                  ...
                  className="w-full text-[var(--text-main)] underline hover:text-[var(--primary)] transition font-semibold"
                >
                  Clear Cart
                </button>
                <button
                  onClick={handleAddAllToCheckout}
                  className="w-full bg-[var(--secondary)] text-white py-2 rounded hover:bg-[var(--primary)] transition font-semibold"
                >
                  Add All to Checkout
                </button>
              </div>
