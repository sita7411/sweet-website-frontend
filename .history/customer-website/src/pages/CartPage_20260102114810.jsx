        ...
        {cart.length === 0 ? (
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1">
              ...
              {/* Desktop Table */}
              <div className="hidden lg:block overflow-x-auto shadow-lg rounded-lg relative">
            ...
            <div className="w-full lg:w-[320px] bg-[var(--bg-card)] p-6 rounded-lg shadow flex flex-col gap-4">
              ...
              <div className="border-t border-gray-300"></div> {/* Divider before Total */}
