      ...
      <div className="container mx-auto mt-10 mb-24 px-4 md:px-10">
        {cart.length === 0 ? (
          ...
          <div className="flex flex-col lg:flex-row gap-8">
                  ...
                  >
                    ...
                    <div className="mt-4 flex flex-col gap-3">
                      ...
                      <div className="flex gap-3">
                        <button
                          className={`flex-1 py-1.5 rounded font-semibold text-white text-sm transition ${
                            item.stock === 'In stock'
            ...
            {/* Right: Order Summary */}
            <div className="w-full lg:w-[320px] bg-[var(--bg-card)] p-4 px-10 rounded-lg shadow flex flex-col gap-2">
              <h2 className="text-lg font-bold text-[var(--text-main)] mb-2">Order Summary</h2>
              ...
              <button
                ...
                className={`w-full py-1.5 rounded font-semibold transition text-white text-sm ${
                  isProcessing
                    ? 'bg-gray-400 cursor-not-allowed'
