...
export default function CheckoutPage() {
    ...
    const [year, month] = form.expiry.split("-");
    const formattedExpiry = `${month}/${year.slice(2)}`; // MM/YY
    ...
    const handleOrder = () => {
        ...
        if (payment === "card") {
            ...
            // Format expiry from YYYY-MM to MM/YY
            if (!form.expiry) {
            ...
            if (!expiryRegex.test(formattedExpiry)) {
