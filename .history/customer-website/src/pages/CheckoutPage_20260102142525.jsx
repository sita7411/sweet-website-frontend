  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-14 grid lg:grid-cols-3 gap-8">
        ...
        {/* RIGHT: Order Summary */}
<div className="bg-white rounded-2xl shadow-lg p-8 h-fit space-y-4">
          ...
          <hr className="my-2" />
          <Row label="Total" value="₹708" bold />

          <button
            onClick={handleOrder}
            className="w-full mt-6 bg-[#6b3f26] text-white py-3 rounded-xl font-semibold hover:opacity-90 transition">
            Place Order
          </button>

          <p className="text-xs text-center mt-4 text-gray-500">🔒 Secure Checkout</p>
        </div>
      </div>
