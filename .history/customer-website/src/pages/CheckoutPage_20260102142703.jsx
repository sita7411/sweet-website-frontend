...
export default function CheckoutPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <section className="relative h-[50vh] flex items-center justify-center">
                ...
                <div className="relative z-10 text-center text-white">
                    ...
                    <div className="mt-3 text-sm flex justify-center gap-2">
                        <Link className="hover:underline" to="/">Home</Link> / <Link className="hover:underline" to="/cart">Cart</Link> / <b>Checkout</b>
                    </div>
                </div>
            </section>
            ...
            <div className="max-w-7xl mx-auto px-4 py-14 grid lg:grid-cols-3 gap-8">
                ...
                {/* RIGHT: Order Summary */}
                <div className="w-full lg:w-[320px] bg-[var(--bg-card)] p-6 rounded-2xl shadow flex flex-col gap-4 self-start">
                    ...
                    <div className="flex justify-between">
                        ...
                        <span>{cart.length || 8}</span>
                    </div>
                    <div className="flex justify-between">
                        <span className="text-[var(--text-muted)]">Sub Total</span>
                        <span>₹{subtotal?.toFixed(2) || 708}</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between font-bold text-[var(--text-main)] text-lg">
                        <span>Total</span>
                        <span>₹{total?.toFixed(2) || 708}</span>
                    </div>

                    <button
                        onClick={handleOrder}
                        className="w-full py-3 rounded-xl font-semibold text-white text-[18px] bg-[var(--primary)] hover:bg-[var(--secondary)] transition"
                    >
                        Place Order
                    </button>
  ...
  return (
            <div className="mt-4">
                ...
                <input {...props} className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-3 focus:outline-none focus:ring-2 focus:ring-[#6b3f26] focus:border-[#6b3f26]" />
            </div>
            );
}
  ...
  return (
            <label className={`flex justify-between items-center p-4 rounded-xl border cursor-pointer
      ${payment === value ? "border-[#6b3f26] bg-[#fffaf3]" : "border-gray-200"} transition`}>
