  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-14 grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl shadow p-3 space-y-6">
        ...
        {/* RIGHT: Order Summary */}
        <div className="w-full lg:w-[370px] bg-white p-5 rounded-2xl shadow flex flex-col gap-4 self-start">
