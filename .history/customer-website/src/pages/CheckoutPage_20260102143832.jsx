...
export default function CheckoutPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* HERO */}
      <section className="relative h-[50vh] md:h-[50vh] flex items-center justify-center">
        <img
          src="/login.png"
        ...
        <div className="relative z-10 text-center text-white px-4">
          ...
          <div className="mt-4 text-sm md:text-base flex justify-center gap-2 flex-wrap">
