    ...
    return (
        <div className="relative w-full">
            ...
            <select
                ...
                className="appearance-none w-full px-4 py-3 border border-gray-300 rounded-xl bg-white text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#6b3f26] focus:border-[#6b3f26] transition shadow-sm hover:shadow-md"
            >
