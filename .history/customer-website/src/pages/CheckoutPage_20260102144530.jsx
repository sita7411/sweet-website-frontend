        ...
        <div className="relative w-full">
            ...
            <div className="relative">
                <select
                    ...
                    className="appearance-none w-full px-5 py-3 border border-gray-300 rounded-xl bg-[var(--bg-card)] text-gray-800 focus:outline-none focus:ring-2 focus:ring-[var(--secondary)] focus:border-[var(--secondary)] transition shadow-sm hover:shadow-md cursor-pointer"
                >
