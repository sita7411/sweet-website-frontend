        ...
        <div className="relative w-full">
            ...
            <div className="relative">
                <select
                    ...
                    className="appearance-none w-full px-5 py-3 border-2 border-gray-300 rounded-xl bg-[var(--bg-card)] text-gray-800 focus:outline-none transition-all duration-300 transform hover:scale-[1.02] hover:border-[var(--primary)] hover:bg-[var(--bg-soft)] focus:border-[var(--primary)] focus:ring-2 focus:ring-[var(--primary)] cursor-pointer"
                >
