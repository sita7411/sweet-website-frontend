...
ffunction Select({ label, required, options = [], value, onChange }) {
  return (
    <div className="w-full">
      ...
      <div className="relative">
        <select
          ...
          className="
            appearance-none w-full px-4 py-3 border border-gray-300 rounded-2xl 
            bg-[var(--bg-card)] text-[var(--text-main)] text-sm font-medium 
            focus:outline-none focus:ring-2 focus:ring-[var(--secondary)] focus:border-[var(--secondary)]
            transition-shadow duration-200 shadow-sm cursor-pointer
            hover:border-[var(--secondary)] hover:text-[var(--secondary)] hover:shadow-md
          "
        >
