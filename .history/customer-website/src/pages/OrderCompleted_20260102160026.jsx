  ...
  return (
    <div className="min-h-screen bg-[var(--bg-main)]">
      ...
      <section className="relative h-[40vh] flex items-center justify-center overflow-hidden">
        <img
          src="/order-banner.png" // replace with your professional banner image
        ...
        <div className="relative z-10 text-center px-4">
          <motion.h1
            ...
            className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white drop-shadow-[0_3px_8px_rgba(0,0,0,0.5)]"
          >
            Order Completed
          </motion.h1>
          <motion.div
      ...
      {/* ===== Main Content ===== */}
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-sm border -mt-16 relative z-20 py-10 px-4">

        {/* ===== Success Message ===== */}
        <div className="text-center py-6 px-6">
          <div className="mx-auto w-14 h-14 rounded-full bg-[var(--accent)] flex items-center justify-center">
            <svg
