      ...
      <div className="container mx-auto mt-24 mb-24 px-4 md:px-10 relative z-20">
        ...
        <div className="mt-8 flex justify-end gap-4">
          <button
            ...
            className="px-6 py-3 rounded border border-[var(--secondary)] text-[var(--secondary)] hover:bg-gray-100 font-semibold"
          >
            Download Invoice
          </button>
          ...
          <Link
            to="/products"
            className="px-6 py-3 rounded bg-[var(--secondary)] text-white font-semibold"
          >
            Continue Shopping
          </Link>
        </div>
...
const TotalRow = ({ label, value, strong }) => (
  <div
    className={`flex justify-between ${
      strong ? "font-bold text-lg" : "text-gray-600"
    }`}
  >
    <span>{label}</span>
    <span>{value}</span>
