...
/* ================= ORDER DATA ================= */
// Note: Yeh aapka original chikki wala data hai - main UI change nahi kar raha
const orderItems = [
...
/* ================= PDF SPECIFIC DATA - IMAGE KE EXACT MATCH KE LIYE ================= */
...
const pdfSubtotal = 225.89;
const pdfDiscount = 0.00;
const pdfTax = 0.00;
const pdfPaid = 0.00;
const pdfTotal = 225.89;
...
export default function OrderCompleted() {
    const downloadInvoice = async () => {
        ...
        // Offscreen dikhane ke liye temporary styling
        ...
        // Layout settle hone ka wait
        await new Promise(res => setTimeout(res, 200));

        // Logo image load hone ka wait
        await Promise.all(
    ...
    return (
        <div className="min-h-screen">
            ...
            {/* ================= HIDDEN PDF DIV - AB EXACTLY IMAGE Jaisa ================= */}
            <div 
                id="invoice-pdf" 
...
/* ================= INVOICE PDF CONTENT - 100% SAME AS YOUR IMAGE ================= */
function InvoicePDF() {
    return (
        <div className="max-w-4xl mx-auto font-sans text-sm">
            ...
            <div className="flex justify-between items-start mb-12">
                <div className="flex items-center gap-6">
                    {/* Original image ke bilkul close cow logo */}
                    <img 
