        ...
        <div className="max-w-4xl mx-auto font-sans text-sm">
            ...
            <div className="flex justify-between items-start mb-12">
                <div className="flex items-center gap-6">
                    {/* Cow logo jo image mein bilkul close hai */}
                    <img 
            ...
            <div className="mb-8 text-left">
                <p className="font-bold">GST No: 24GCFPB5431P1ZH</p>
                <p>Plot no 133, Shreeji textile Velenja sayan road</p>
                <p>Nr ramvatika Velenja-394150</p>
            </div>
            ...
            {/* Items Table */}
            <table className="w-full border border-gray-600 mb-12 table-fixed">
                <thead className="bg-gray-100">
                    <tr>
                        <th className="border border-gray-600 px-5 py-4 text-left">Item</th>
                        <th className="border border-gray-600 px-5 py-4 text-center">Quantity</th>
                        <th className="border border-gray-600 px-5 py-4 text-center">Rate</th>
                        <th className="border border-gray-600 px-5 py-4 text-center">Tax</th>
                        <th className="border border-gray-600 px-5 py-4 text-right">Amount</th>
                    </tr>
                </thead>
                <tbody>
                    {pdfOrderItems.map((item, index) => (
                        <tr key={index}>
                            <td className="border border-gray-600 px-5 py-4">
                                {item.title}
                                <br />
                                <span className="text-gray-600 text-xs">per {item.unit}</span>
                            </td>
                            <td className="border border-gray-600 px-5 py-4 text-center">
                                {item.quantity}
                                <br />
                            ...
                            <td className="border border-gray-600 px-5 py-4 text-center">$0.00</td>
                            <td className="border border-gray-600 px-5 py-4 text-right">${item.amount.toFixed(2)}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
            ...
            <div className="flex justify-end mb-10">
                <div className="w-80 space-y-3">
                    <div className="flex justify-between"><span>Subtotal:</span> <span>${pdfSubtotal.toFixed(2)}</span></div>
                    <div className="flex justify-between"><span>Discount:</span> <span>${pdfDiscount.toFixed(2)}</span></div>
                    <div className="flex justify-between"><span>Tax:</span> <span>${pdfTax.toFixed(2)}</span></div>
                    <div className="flex justify-between"><span>Paid:</span> <span>${pdfPaid.toFixed(2)}</span></div>
                </div>
            </div>
            ...
            <div className="flex justify-end mb-20">
                <div className="bg-blue-900 text-white px-16 py-5 rounded-lg">
                    <span className="text-2xl font-bold">Total ${pdfTotal.toFixed(2)}</span>
                </div>
            </div>
            ...
            <div className="mt-10">
                ...
                <p className="mt-4 italic">Marvel Crunch Chikki included in this invoice.</p>
            </div>
        </div>
    );
}