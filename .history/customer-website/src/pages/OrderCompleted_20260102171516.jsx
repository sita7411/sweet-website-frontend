...
/* ================= ORDER DATA - AAPKA ORIGINAL UI KE LIYE ================= */
const orderItems = [
...
/* ================= PDF KE LIYE DATA - IMAGE KE EXACT MATCH + AAPKA NAYA CONTENT ================= */
...
const pdfOrderItems = [
    ...
    // Aapka naya product add kiya (example values - aap change kar sakte ho)
    { title: "Marvel Crunch Chikki", quantity: 10, unit: "pack", rate: 50.00, amount: 500.00 },
];

const pdfSubtotal = 731.89;  // Updated with Marvel Crunch example
...
export default function OrderCompleted() {
    ...
    return (
        <div className="min-h-screen">
            ...
            {/* ================= HIDDEN PDF DIV - AB BILKUL SAME AS AAPKI IMAGE ================= */}
            <div 
                id="invoice-pdf" 
...
/* ================= INVOICE PDF CONTENT - EXACTLY SAME UI AS IMAGE + AAPKA NAYA CONTENT ================= */
function InvoicePDF() {
    return (
        <div className="max-w-4xl mx-auto font-sans text-sm leading-relaxed">
            {/* Header - Logo + Milky Bakery + INVOICE */}
            <div className="flex justify-between items-start mb-12">
                <div className="flex items-center gap-6">
                    {/* Exact same cow logo from the image */}
                    <img 
                        src="https://www.logodesign.net/logo-new/frontal-cow-face-with-splashing-bowl-of-milk-6947ld.png?size=large" 
                        alt="Milky Bakery Logo" 
                        className="w-20 h-20 object-contain"
                        crossOrigin="anonymous"
                    />
                    <h1 className="text-3xl font-bold">Milky Bakery</h1>
                </div>
                <div>
                    <h2 className="text-5xl font-bold text-blue-900 pb-2 border-b-8 border-blue-900 inline-block">INVOICE</h2>
                </div>
            </div>

            {/* Invoice Number & Date */}
            <div className="mb-10 space-y-1">
                <p><strong>Invoice Number:</strong> 891</p>
                <p><strong>Date:</strong> 02/02/2022</p>
            </div>

            {/* Bill From / Bill To - Exactly like image */}
            <div className="grid grid-cols-2 gap-16 mb-12">
                <div>
                    <p className="font-bold mb-3">Bill from:</p>
                    <p>Company Name</p>
                    <p>Street Address, Zip Code</p>
                    <p>Phone Number</p>
                </div>
                <div>
                    <p className="font-bold mb-3">Bill to:</p>
                    <p>Customer Name</p>
                    <p>Street Address, Zip Code</p>
                    <p>Phone Number</p>
                </div>
            ...
            {/* Items Table - Exact same structure and styling as image */}
            <table className="w-full border-collapse border border-gray-700 mb-12">
                <thead>
                    <tr className="bg-gray-100">
                        <th className="border border-gray-700 px-4 py-3 text-left">Item</th>
                        <th className="border border-gray-700 px-4 py-3 text-center">Quantity</th>
                        <th className="border border-gray-700 px-4 py-3 text-center">Rate</th>
                        <th className="border border-gray-700 px-4 py-3 text-center">Tax</th>
                        <th className="border border-gray-700 px-4 py-3 text-right">Amount</th>
                    </tr>
                </thead>
                <tbody>
                    {/* Your Chikki Products - Aap yeh change kar sakte ho */}
                    <tr>
                        <td className="border border-gray-700 px-4 py-3">
                            Classic Peanut Chikki
                            <br /><span className="text-xs text-gray-600">per pack</span>
                        </td>
                        <td className="border border-gray-700 px-4 py-3 text-center">
                            10<br /><span className="text-xs text-gray-600">pack</span>
                        </td>
                        <td className="border border-gray-700 px-4 py-3 text-center">
                            $12.00<br /><span className="text-xs text-gray-600">per pack</span>
                        </td>
                        <td className="border border-gray-700 px-4 py-3 text-center">$0.00</td>
                        <td className="border border-gray-700 px-4 py-3 text-right">$120.00</td>
                    </tr>
                    <tr>
                        <td className="border border-gray-700 px-4 py-3">
                            Pista Chocolate Chikki
                            <br /><span className="text-xs text-gray-600">per pack</span>
                        </td>
                        <td className="border border-gray-700 px-4 py-3 text-center">
                            8<br /><span className="text-xs text-gray-600">pack</span>
                        </td>
                        <td className="border border-gray-700 px-4 py-3 text-center">
                            $18.00<br /><span className="text-xs text-gray-600">per pack</span>
                        </td>
                        <td className="border border-gray-700 px-4 py-3 text-center">$0.00</td>
                        <td className="border border-gray-700 px-4 py-3 text-right">$144.00</td>
                    </tr>
                    <tr>
                        <td className="border border-gray-700 px-4 py-3">
                            Til Gud Chikki
                        ...
                        <td className="border border-gray-700 px-4 py-3 text-center">
                            15<br /><span className="text-xs text-gray-600">pack</span>
                        </td>
                        <td className="border border-gray-700 px-4 py-3 text-center">
                            $9.50<br /><span className="text-xs text-gray-600">per pack</span>
                        </td>
                        <td className="border border-gray-700 px-4 py-3 text-center">$0.00</td>
                        <td className="border border-gray-700 px-4 py-3 text-right">$142.50</td>
                    </tr>
                </tbody>
            </table>
            ...
            {/* Final Total Box - Exact blue box */}
            <div className="flex justify-end mt-8 mb-20">
                <div className="bg-blue-900 text-white px-16 py-5 rounded-lg">
                    <span className="text-2xl font-bold">Total $406.50</span>
                </div>
            </div>
            ...
            <div className="mt-10">
                ...
                {/* Aap yahan apne terms likh sakte ho */}
