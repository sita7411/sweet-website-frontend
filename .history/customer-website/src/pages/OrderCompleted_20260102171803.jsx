...
function InvoicePDF() {
    return (
        <div
            className="max-w-4xl mx-auto font-sans text-sm leading-relaxed text-black"
        ...
        >
            ...
            <div className="flex justify-between items-center mb-12">
                ...
                <h2 className="text-4xl font-bold text-blue-900 border-b-4 border-blue-900 pb-1">INVOICE</h2>
            </div>
            ...
            {/* Items Table */}
            <table className="w-full border-collapse border border-gray-700 mb-12 text-sm">
                <thead>
                    <tr className="bg-gray-100">
                        ...
                        <th className="border border-gray-700 px-4 py-2 text-center">Rate</th>
                        <th className="border border-gray-700 px-4 py-2 text-center">Tax</th>
                    ...
                    {pdfOrderItems.map((item, idx) => (
                        <tr key={idx} className="border-b border-gray-700">
                            <td className="border border-gray-700 px-4 py-2">
                                {item.title}
                                <br /><span className="text-xs text-gray-600">per {item.unit}</span>
                            </td>
                            <td className="border border-gray-700 px-4 py-2 text-center">
                                {item.quantity}<br /><span className="text-xs text-gray-600">{item.unit}</span>
                            </td>
                            <td className="border border-gray-700 px-4 py-2 text-center">
                                ${item.rate.toFixed(2)}<br /><span className="text-xs text-gray-600">per {item.unit}</span>
                            </td>
                            <td className="border border-gray-700 px-4 py-2 text-center">$0.00</td>
                            <td className="border border-gray-700 px-4 py-2 text-right">${item.amount.toFixed(2)}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
            ...
            <div className="flex justify-end">
                <div className="w-80 space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                        <span>Discount:</span>
                        <span>${pdfDiscount.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between">
                        <span>Tax:</span>
                        <span>${pdfTax.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between">
                        <span>Paid:</span>
                        <span>${pdfPaid.toFixed(2)}</span>
                    </div>
                </div>
            </div>
