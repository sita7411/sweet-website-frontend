...
function InvoicePDF() {
    return (
        <div
            className="max-w-4xl mx-auto font-sans text-sm leading-relaxed"
            style={{
                width: "210mm",
                minHeight: "297mm",
                padding: "20mm",
        ...
        >
            ...
            <div className="flex justify-between items-center mb-10">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-[var(--text-muted)] text-sm">Freshly made Chikki & Bakery Products</p>
                    </div>
                </div>
                <h2 className="text-3xl font-bold text-[var(--secondary)] border-b-4 border-[var(--secondary)] pb-1">
                    INVOICE
                </h2>
            </div>
            ...
            <table className="w-full border border-gray-300 mb-8 text-sm">
                <thead style={{ backgroundColor: "var(--accent)", color: "var(--text-main)" }}>
                    <tr>
                ...
                <tbody>
                    {pdfOrderItems.map((item, idx) => (
                        <tr key={idx} className="border-b border-gray-300">
                            ...
                            <td className="border px-4 py-2 text-center">₹{item.rate.toFixed(2)}</td>
                            <td className="border px-4 py-2 text-center">₹0.00</td>
