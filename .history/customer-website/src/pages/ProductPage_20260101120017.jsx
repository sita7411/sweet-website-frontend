...
// Product data
const products = [
  { title: 'Pista Chocolate Chikki', desc: 'Chocolate & Peanut Blend', price: 250, img: 'pista.png', hoverImg: 'choclate.png', category: 'Bestseller' },
  { title: 'Strawberry Delight', desc: 'Fruity Crunch Chikki', price: 350, img: 'stwabarry_chikki.png', hoverImg: 'mango_chikki.png', category: 'Seasonal' },
  { title: 'Mango Fusion', desc: 'Seasonal Mango Flavor', price: 179, img: 'mango_chikki.png', hoverImg: 'pista.png', category: 'Seasonal' },
  { title: 'Chocolate Crunch', desc: 'Rich Cocoa Coated', price: 199, img: 'choclate.png', hoverImg: 'kalakand.png', category: 'Bestseller' },
  { title: 'Classic Peanut', desc: 'Traditional Taste', price: 149, img: 'pista.png', hoverImg: 'choclate.png', category: 'Healthy' },
  { title: 'Dryfruit Mix', desc: 'Premium Nuts', price: 399, img: 'kalakand.png', hoverImg: 'pista.png', category: 'Premium' },
  { title: 'Rose Almond', desc: 'Royal Flavor', price: 289, img: 'stwabarry_chikki.png', hoverImg: 'mango_chikki.png', category: 'New' },
  { title: 'Jaggery Special', desc: 'Pure Desi Gud', price: 129, img: 'mango_chikki.png', hoverImg: 'pista.png', category: 'Healthy' },
];
      ...
      <section className="py-14">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1 sticky top-20">
            <h3 className="font-semibold text-[var(--text-main)] mb-4 text-lg">Filter by Category</h3>
              ...
              {categories.map((cat, i) => (
                <button
                  ...
                  className={`text-left px-4 py-2 rounded-lg transition font-medium
                    ${activeCategory === cat
                      ? 'bg-[var(--accent)] text-[var(--secondary)] shadow'
          ...
          <div className="lg:col-span-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8">
            {filteredProducts.map((item, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -6 }}
                className="rounded-3xl p-5 relative group shadow-lg bg-[var(--bg-card)] hover:shadow-2xl transition"
              >
                ...
                <div className="flex items-center justify-between mt-4">
                  <p className="text-lg font-bold text-[var(--secondary)]">{formatPrice(item.price)}</p>
                  {!qty[i] ? (
                    <button
