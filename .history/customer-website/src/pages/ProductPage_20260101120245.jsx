...
// Product data with weight variants
const products = [
  {
...
export default function ProductPage() {
  ...
  const [selectedVariant, setSelectedVariant] = useState({}); // stores chosen weight per product
                ...
                >
                  ...
                  <div className="mt-3">
                    <select
                      ...
                      className="w-full px-3 py-1.5 border border-gray-300 rounded-full text-sm focus:ring-1 focus:ring-[var(--accent)] focus:outline-none"
                    >
                      {Object.keys(item.variants).map((w, idx) => (
