...
<div className="mb-4 flex flex-wrap gap-2 items-center">
  {activeCategory !== 'All' && (
    <span className="px-3 py-1 text-xs bg-[var(--accent)] text-white rounded-full flex items-center gap-1">
      {activeCategory}
      <button onClick={() => setActiveCategory('All')} className="ml-1 font-bold">×</button>
    </span>
  )}
  ...
  {activeWeight !== 'All' && (
    <span className="px-3 py-1 text-xs bg-[var(--accent)] text-white rounded-full flex items-center gap-1">
      {activeWeight}
      <button onClick={() => setActiveWeight('All')} className="ml-1 font-bold">×</button>
    </span>
  )}
  ...
  {searchTerm && (
    <span className="px-3 py-1 text-xs bg-[var(--accent)] text-white rounded-full flex items-center gap-1">
      "{searchTerm}"
      <button onClick={() => setSearchTerm('')} className="ml-1 font-bold">×</button>
    </span>
  )}
</div>
          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-2">
              <p className="text-sm text-[var(--text-muted)] mb-2 sm:mb-0">
