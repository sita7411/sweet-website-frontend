...
export default function ProductPage() {
    ...
    return (
        <div className="min-h-screen font-sans">
            {/* Hero */}
{/* Hero / Products Banner – THEME MATCHED */}
<section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
  ...
  <div className="absolute inset-0 
    bg-gradient-to-b 
    from-[rgba(198,59,47,0.10)] 
    via-[rgba(107,63,38,0.45)] 
    to-[rgba(0,0,0,0.55)]">
  </div>
  ...
  <div className="relative z-10 text-center px-4">
    ...
    <motion.h1
      ...
      className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-[var( --text-main)] tracking-wide"
    >
      Products
    </motion.h1>
    ...
    >
      <span className="text-[var(--bg-soft)] opacity-90">
        Home
      </span>
