...
export default function ProductPage() {
  ...
  drop-shadow-[0_3px_8px_rgba(107,63,38,0.6)]"                    >
                    ...
                    >
                        ...
                        <Link
                            to="/"
                            className="text-[var(--text-muted)] hover:text-[yellow-400] transition-colors duration-300"
                        >
                            Home
                        </Link>
                        ...
                        <Link
                            to="/products"
                            className="text-[var(--text-muted)]  font-semibold hover:text-yellow-400 transition-colors duration-300"
                        >
                            Products
                        </Link>
