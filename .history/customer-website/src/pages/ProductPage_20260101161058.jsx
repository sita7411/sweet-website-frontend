...
export default function ProductPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* HERO */}
      <section className="relative h-[55vh] sm:h-[60vh] md:h-[70vh] flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          ">
            <input
              ...
              className="w-full border px-4 py-3 rounded-xl text-sm"
            />
          </aside>
              ...
              {displayedProducts.map(item => {
                ...
                return (
                  <div key={item.id} className="bg-[var(--bg-card)] rounded-3xl p-5 shadow-lg">
                    <div className="h-40 sm:h-44 md:h-48 mb-4 overflow-hidden rounded-2xl">
