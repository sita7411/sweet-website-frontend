      ...
      <div className="container mx-auto mt-12 mb-12 px-4 md:px-10">
        {wishlist.length === 0 ? (
          ...
          <>
                    ...
                    >
                      ...
                      <td className="py-4 px-6">
                        <input
                          ...
                          className="w-16 border px-2 py-1 rounded text-center focus:outline-none focus:ring-2 focus:ring-[var(--secondary)]"
                        />
                      </td>
            ...
            {/* Total Price */}
            <div className="text-right mt-4 font-semibold text-lg text-[var(--text-main)]">
