        ...
        <div className="min-h-screen">
            ...
            <div className="container mx-auto mt-12 mb-12 px-4 md:px-10">
                {wishlist.length === 0 ? (
                    ...
                    <>
                        <div className="overflow-x-auto shadow-lg rounded-lg -mx-4 md:mx-0">
                            <table className="w-full min-w-[700px] text-left border border-gray-200">
                                <thead className="bg-[var(--accent)] text-[var(--text-main)]">
                                    <tr>
                                        <th className="py-3 px-4 text-sm md:px-6">Product</th>
                                        <th className="py-3 px-4 text-sm md:px-6">Price</th>
                                        <th className="py-3 px-4 text-sm md:px-6">Quantity</th>
                                        <th className="py-3 px-4 text-sm md:px-6">Date Added</th>
                                        <th className="py-3 px-4 text-sm md:px-6">Stock Status</th>
                                        <th className="py-3 px-4 text-sm md:px-6">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        >
                                            <td className="py-4 px-4 md:px-6 flex items-center gap-4">
                                                <img
                                                    src={item.img}
                                                    alt={item.title}
                                                    className="w-12 h-12 md:w-16 md:h-16 object-cover rounded shadow-sm flex-shrink-0"
                                                />
                                                <div>
                                            ...
                                            <td className="py-4 px-4 md:px-6 font-medium text-sm md:text-base">
                                                ${item.price.toFixed(2)}
                                            </td>
                                            <td className="py-4 px-4 md:px-6">
                                                <div className="flex items-center border border-gray-300 rounded-md overflow-hidden w-20 md:w-24">
                                                    <button
                                                        onClick={() =>
                                                        ...
                                                        className="px-2 py-1 text-gray-700 text-sm transition hover:bg-gray-100"
                                                    >
                                                        -
                                                    </button>
                                                    <input
                                                        ...
                                                        className="w-full text-center px-1 py-1 text-sm focus:outline-none"
                                                    />
                                                    <button
                                                        onClick={() =>
                                            ...
                                            <td className="py-4 px-4 md:px-6 text-sm">{item.date}</td>
                                            <td
                                                className={`py-4 px-4 md:px-6 font-medium text-sm ${
                                            ...
                                            <td className="py-4 px-4 md:px-6">
                                                <div className="flex flex-col gap-2">
                                                    <button
                                                        className={`px-3 py-2 rounded text-white font-medium text-sm transition ${
                                                            item.stock === 'In stock'
                                                    ...
                                                    <button
                                                        className="px-3 py-2 rounded border border-red-500 text-red-500 hover:bg-red-500 hover:text-white transition text-sm font-medium"
                        ...
                        <div className="mt-8 flex justify-center md:justify-end">
                            <div className="bg-[var(--secondary)] text-white px-6 py-4 rounded-lg shadow-md font-semibold text-lg w-full max-w-xs md:w-auto md:min-w-[200px] text-center">
                                Total: ${totalPrice.toFixed(2)}
                            </div>
                        </div>

                        {/* Wishlist Actions */}
                        <div className="mt-10 flex flex-col gap-8 px-4 md:px-0">
                            <div className="flex flex-col sm:flex-row gap-3 w-full">
                                <input
                                    type="text"
                                    readOnly
                                    value="https://www.chikkistore.com/wishlist"
                                    className="border border-gray-300 px-4 py-2 rounded flex-1 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--secondary)]"
                                />
                                <button
