        ...
        {wishlist.length === 0 ? (
          ...
          <>
            <div className="overflow-hidden shadow-lg rounded-lg">
              <table className="w-full text-left border border-gray-200 table-auto md:table-fixed">
                {/* Header hidden on mobile */}
                <thead className="bg-[var(--accent)] text-[var(--text-main)] hidden md:table-header-group">
                  <tr>
                ...
                <tbody className="flex flex-col md:table-row-group gap-4">
                  {wishlist.map((item, index) => (
                    <motion.tr
                      ...
                      className="border-b border-gray-200 hover:bg-[var(--bg-soft)] transition flex flex-col md:table-row p-4 md:p-0 rounded md:rounded-none"
                    >
                      {/* Product Info */}
                      <td className="py-2 px-0 md:py-4 md:px-6 flex items-center gap-4 md:flex-[2]">
                        <img
                          src={item.img}
                          alt={item.title}
                      ...
                      {/* Price */}
                      <td className="hidden md:block md:flex-1 font-medium">
                        ${item.price.toFixed(2)}
                      </td>

                      {/* Quantity */}
                      <td className="my-2 md:my-0 md:flex-1">
                      ...
                      {/* Date */}
                      <td className="hidden md:block md:flex-1">{item.date}</td>
                      ...
                      {/* Actions */}
                      <td className="flex flex-col sm:flex-row gap-2 md:flex-1 md:justify-center">
                        <button
