...
const Wishlist = () => {
    ...
    return (
        <div className="min-h-screen">
            ...
            {/* Wishlist Table */}
            <div className="container mx-auto mt-7 mb-22 px-4 md:px-10">
                {wishlist.length === 0 ? (
                    <div className="text-center py-10 flex flex-col items-center justify-center gap-1 text-[var(--text-muted)] font-semibold">
                        ...
                        {/* Main Message */}
                        <p className="text-lg md:text-xl -mt-6  font-semibold text-[var(--text-main)]">
