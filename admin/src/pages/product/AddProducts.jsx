                  ...
                  ${i === 0 ? "ring-2 ring-[var(--primary)]" : ""}`}
                    ...
                    <Section title="Product Status">
                        ...
                        >
                            ...
                            <div
                                className={`w-11 h-6 rounded-full relative transition ${status ? "bg-green-500" : "bg-gray-400"
                                    }`}
                            >
                                <div
                                    className={`w-5 h-5 bg-white rounded-full absolute top-0.5 transition ${status ? "right-0.5" : "left-0.5"
                                        }`}
                                />
                            </div>
                        </div>
