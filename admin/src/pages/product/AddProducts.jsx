...
export default function AddProduct() {
  ...
  const handlePublish = async () => {
    ...
    if (hasEmptyStock)
      return toast.error("Please fill stock quantity for all weights");
    ...
    try {
      ...
      if (!adminToken) {
        toast.error("Admin login required. Please login again.");
        return;
      }
      ...
      let msg = err?.response?.data?.message || "Failed to publish product";
              ...
              {weights.map((w, i) => (
                ...
                >
                  <Input
                    ...
                    value={w.weight}
                    onChange={(e) =>
                      updateWeightField(i, "weight", e.target.value)
                    }
                  ...
                  <Input
                    ...
                    value={w.mrp}
                    onChange={(e) =>
                      updateWeightField(i, "mrp", e.target.value)
                    }
                  />
                  <Input
                    label="Selling Price"
                    ...
                    onChange={(e) =>
                      updateWeightField(i, "sellingPrice", e.target.value)
                    }
                  />
                  <Input
                    label="Stock"
                    ...
                    onChange={(e) =>
                      updateWeightField(i, "stockQuantity", e.target.value)
                    }
                  />
                  {weights.length > 1 && (
                    <button
        ...
        <div className="space-y-5 sm:space-y-6">
              ...
              <div className="relative">
                ...
                <div className="min-h-[42px] flex flex-wrap gap-2 p-2 border border-gray-300 rounded-lg bg-white focus-within:border-[var(--primary)] focus-within:ring-2 focus-within:ring-[var(--primary)]/20 transition shadow-sm">
                  ...
                  <input
                    ...
                    placeholder={
                      tags.length === 0
                        ? "Type tag and press Enter, comma or space..."
                        : "Add more..."
                    }
          ...
          <Section title="Product Status">
            <div
              ...
              className={`flex justify-between items-center px-4 py-3 rounded-lg cursor-pointer border transition-colors ${
                status
            ...
            >
              ...
              <div
                className={`w-11 h-6 rounded-full relative ${status ? "bg-green-500" : "bg-gray-400"}`}
              >
                <div
