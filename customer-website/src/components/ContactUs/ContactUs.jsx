                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 rounded-3xl p-10 ">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-[var(--text-muted)] mb-10 leading-relaxed">
                           Get in touch to place an order, discuss custom gift boxes, Call us, drop us an email, or visit us - we’d love to hear from you.
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-stretch">
                            {[
                                ...
                                },
                                {
                                    ...
                                    title: "Email",
                                    value: "Info@MarvelCrunch.com",
                                },
                                {
                                    icon: <MapPin className="w-4 h-4 " />,
                                    title: "Location",
                                    value: "Plot No. 133, Shreeji Textile Velenja Sayan Road, Nr.Ramvatika Velenja – 394150",
                                },
...
">
                  ...
                  focus:outline-none focus:ring-2 focus:ring-[var(--primary)]/40"
                            ...
                            <div>
                                ...
                                <div className="relative mt-2">
                                    <select
                                        required
                                        className="w-full appearance-none border rounded-lg px-4 py-3 pr-10
                ...
                text-white py-3 rounded-full text-sm font-semibold transition"
                            >
