...
export default function HeroBanner() {
  return (
    <section className="relative bg-[#fff6e8] overflow-hidden pt-20 md:pt-24 pb-36 md:pb-48">
      ...
      <img
        src="/nuts.png"
        className="hidden md:block absolute bottom-32 left-6 md:left-10 w-40 md:w-60 opacity-60 animate-float"
        alt=""
      />
      <img
        src="/sesame.png"
        className="hidden md:block absolute bottom-32 right-6 md:right-10 w-40 md:w-60 opacity-60 animate-floatSlow"
        alt=""
      />
